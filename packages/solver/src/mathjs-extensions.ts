...
function registerCurrencyUnits(math: MathInstance, ratesData: ExchangeRateData): void {
    try {
...
export function getMathInstance(emCss: number, ratesData: ExchangeRateData | null): MathInstance {
