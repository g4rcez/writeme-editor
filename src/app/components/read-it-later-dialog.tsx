    ...
    const handleCreate = async (e: FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (isElectron()) {
                ...
                if (!result.success) throw new Error(result.error || "Failed to fetch URL");
                html = result.html!;
            } else {
    ...
    return (
        ...
        >
            <form onSubmit={handleCreate} className="flex flex-col gap-6">
                <p className="text-sm">Enter a URL to fetch its content and save it as a note.</p>
                <Input
                    required
                    type="url"
                    value={url}
                ...
                <div className="flex gap-2 justify-end">
                    ...
                    <Button type="submit" disabled={!url} theme="primary" loading={loading}>
