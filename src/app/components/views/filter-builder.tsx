...
const OPERATORS_BY_TYPE: Record<FieldType, { value: ComparisonOp; label: string }[]> = {
    string: [
        { value: "=", label: "equals" },
...
export function FilterBuilder({ group, onChange }: FilterBuilderProps) {
    ...
    return (
        <div className="flex flex-col gap-3">
            ...
            <Button type="button" theme="ghost-muted" size="small" onClick={addRow} className="self-start">
                <PlusIcon size={14} />
                Add condition
            </Button>
        </div>
