  ...
  return (
    <div className="flex flex-col h-full bg-background/50">
      ...
      <div className="overflow-y-auto flex-1 scrollbar-hide">
        {notes.length === 0 ? (
          <div className="flex flex-col gap-4 justify-center items-center h-40 text-sm text-muted-foreground">
          ...
          <ul className="divide-y divide-border/20">
            <li
              onClick={createNewNote}
              className="flex gap-2 items-center p-4 text-sm transition-all cursor-pointer text-muted-foreground hover:bg-muted/30 hover:text-foreground"
            >
              <Plus className="size-4" />
              <span>New note</span>
            </li>
