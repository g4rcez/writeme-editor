        ...
        <header className="border-b border-floating-border px-6 py-5">
          ...
          <div className="flex flex-col gap-3 xl:flex-row xl:items-center">
            ...
            <div className="flex flex-wrap items-center gap-2">
              <Button size="small" theme="muted" onClick={handleCreateFile} className="gap-2" title="New File (T)">
                <FilePlusIcon className="size-4" />
                <span>File</span>
                <Shortcut value="T" />
              </Button>
              <Button size="small" theme="muted" onClick={handleCreateFolder} className="gap-2" title="New Folder (N)">
