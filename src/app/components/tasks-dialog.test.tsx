        ...
        cb(
          {
            ...
            nodeSize: 5,
            forEach: (f: any) =>
              f({ type: { name: "paragraph" }, textContent: "Task 1" }, 0),
          },
          11,
        );
        ...
        cb(
          {
            ...
            nodeSize: 5,
            forEach: (f: any) =>
              f({ type: { name: "paragraph" }, textContent: "Task 2" }, 0),
          },
          31,
        );
      },
    ...
    const mockEditor: any = {
      state: {
        doc: {
          nodeAt: vi
            .fn()
            .mockReturnValue({ type: { name: "paragraph" }, nodeSize: 10 }),
        },
        tr: mockTr,
      },
    };
    ...
    const mockEditor: any = {
      state: {
        doc: {
          ...
          resolve: vi
            .fn()
            .mockReturnValue({ parent: { type: { name: "taskList" } } }),
          nodeAt: vi.fn(),
        },
        tr: mockTr,
        schema: mockSchema,
