...
export const TabsBar: React.FC = () => {
  ...
  return (
    <div
      ref={scrollRef}
      className="flex overflow-x-auto sticky flex-row items-center mx-auto w-full h-10 select-none z-navbar top-navbar max-w-safe bg-background isolate scrollbar-none"
    >
