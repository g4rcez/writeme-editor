...
export const AITooltip = ({ editor, trigger }: { editor: Editor; trigger: React.ReactNode }) => {
    ...
    return (
        <Tooltip popover open={open} hover={false} title={trigger} onChange={setOpen}>
            <div className="flex flex-col gap-2 w-80">
                ...
                <Input
                    ...
                    right={
                        <button type="button" onClick={onSubmit} className="p-1 transition-colors text-primary">
                ...
                <div className="flex justify-between items-center px-1 text-xs text-muted-foreground">
                    <span>
                        Press <kbd className="px-1 font-sans">⌘</kbd> + <kbd className="px-1 font-sans">Enter</kbd> to
                        send
                    </span>
                </div>
            </div>
