...
export class GeminiAdapter implements AIAdapter {
    ...
    async auth(method: "oauth" | "api-key", apiKey?: string): Promise<AuthCredentials> {
        ...
        return authManager.startOAuthFlow("gemini") as unknown as Promise<AuthCredentials>;
    }
    ...
    async *sendMessage(
        ...
        const google = createGoogleGenerativeAI({
            ...
            fetch: proxyFetch,
            headers: creds.accessToken ? { Authorization: `Bearer ${creds.accessToken}` } : undefined,
        });
