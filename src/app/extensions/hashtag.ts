...
const HEX_COLOR_TAG_RE = /^[0-9a-fA-F]{3}$|^[0-9a-fA-F]{4}$|^[0-9a-fA-F]{6}$|^[0-9a-fA-F]{8}$/;
...
function scanRange(doc: PmNode, from: number, to: number, out: Decoration[], tags: Set<string>) {
