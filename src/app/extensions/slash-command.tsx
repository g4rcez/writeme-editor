...
const SLASH_COMMANDS: SlashCommandItem[] = [
    ...
    },
    {
        ...
        icon: ArrowRightIcon,
        group: "Blocks",
        command: (editor, range) => editor.chain().focus().deleteRange(range).wrapIn("callout", { type: "note" }).run(),
    },
    {
        label: "Code Block",
    ...
    },
    {
        ...
        group: "Inserts",
        command: (editor, range) =>
            editor.chain().focus().deleteRange(range).insertContent({ type: "frontmatter" }).run(),
    },
    {
        label: "Inline Math",
    ...
    },
    {
        ...
        icon: MathOperationsIcon,
        group: "CodeBlock",
        command: (editor, range) => editor.chain().focus().deleteRange(range).setCodeBlock({ language: "math" }).run(),
    },
    {
        label: "Excalidraw",
        ...
        group: "CodeBlock",
        command: (editor, range) =>
            editor.chain().focus().deleteRange(range).setCodeBlock({ language: "excalidraw" }).run(),
    },
    {
        label: "Freehand",
        ...
        group: "CodeBlock",
        command: (editor, range) =>
            editor.chain().focus().deleteRange(range).setCodeBlock({ language: "freehand" }).run(),
    },
    {
        label: "Flowchart",
        ...
        group: "CodeBlock",
        command: (editor, range) =>
            editor.chain().focus().deleteRange(range).setCodeBlock({ language: "flowchart" }).run(),
    },
    {
        label: "Mermaid",
