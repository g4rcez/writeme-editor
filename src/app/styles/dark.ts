...
export const darkTheme: typeof defaultDarkTheme = {
  ...
  colors: {
    ...
    foreground: "hsla(131, 37%, 77%)",
    background: "hsla(0, 0%, 9%)",
    border: "hsla(245, 32%, 22%)",
    ...
    input: {
      border: "hsla(245, 32%, 24%)",
      placeholder: "hsla(131, 20%, 50%)",
      "mask-error": "hsla(0, 94%, 81%)",
      "switch-bg": "hsla(0, 0%, 18%)",
      switch: "hsla(131, 37%, 77%)",
      slider: "hsla(131, 37%, 77%)",
    },
    card: {
      muted: "hsla(0, 0%, 11%)",
      border: "hsla(245, 32%, 18%)",
