...
export const darkTheme: typeof defaultDarkTheme = {
  ...
  colors: {
    foreground: "hsla(220,15%,90%)",
    background: "hsla(225,15%,10%)",
    border: "hsla(225, 10%, 20%)",
    muted: "hsla(225, 12%, 35%)",
    disabled: "hsla(225,12%,55%)",
    emphasis: {
    ...
    primary: {
      ...
      DEFAULT: "hsla(221,83%,60%)",
      subtle: "hsla(221,60%,25%)",
      hover: "hsla(221,83%,50%)",
    },
    secondary: {
      DEFAULT: "hsla(252, 67%, 65%)",
      background: "hsla(252, 40%, 25%)",
      subtle: "hsla(252, 30%, 30%)",
      hover: "hsla(252, 67%, 75%)",
      foreground: "hsla(252, 67%, 90%)",
    },
    info: {
