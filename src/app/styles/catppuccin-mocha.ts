...
export const catppuccinMochaTheme: typeof defaultDarkTheme = {
	...
	colors: {
		...
		secondary: {
			foreground: "hsla(240, 24%, 9%)",
			DEFAULT: "hsla(217, 92%, 78%)",
			subtle: "hsla(217, 50%, 20%)",
			hover: "hsla(217, 92%, 72%)",
		...
		danger: {
			DEFAULT: "hsla(343, 81%, 79%)",
			subtle: "hsla(343, 50%, 20%)",
			hover: "hsla(343, 81%, 72%)",
			foreground: "hsla(240, 24%, 9%)",
			notification: "hsla(343, 81%, 79%)",
		},
		success: {
		...
		input: {
			...
			placeholder: "hsla(230, 13%, 78%)",
			"mask-error": "hsla(343, 81%, 79%)",
