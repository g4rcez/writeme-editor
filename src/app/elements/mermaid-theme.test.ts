...
describe("createMermaidThemeVariables", () => {
  it("uses a darker high-contrast token pair for flowchart nodes", () => {
    ...
    expect(mermaidThemeVariables.primaryColor).toBe(
      "hsla(var(--primary-subtle))",
    );
    expect(mermaidThemeVariables.primaryTextColor).toBe(
      "hsla(var(--foreground))",
    );
    expect(mermaidThemeVariables.nodeBorder).toBe(
      "hsla(var(--primary-DEFAULT))",
    );
  });
  ...
  it("uses foreground/background tokens for diagram lines and labels", () => {
    ...
    expect(mermaidThemeVariables.defaultLinkColor).toBe(
      "hsla(var(--foreground))",
    );
    expect(mermaidThemeVariables.edgeLabelBackground).toBe(
      "hsla(var(--background))",
    );
