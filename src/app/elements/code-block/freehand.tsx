...
export const FreehandCode = (props: { code: string; autoDelete: () => void; onChange?: (s: string) => void }) => {
    ...
    return (
        <div ref={ref} className="relative w-full bg-card" contentEditable={false}>
            <div className="flex items-center gap-2 px-3 py-2 border-b border-card-border bg-card-background flex-wrap">
                ...
                <div className="ml-auto flex gap-2">
                    <Button
                        ...
                        aria-label={isFullScreen ? "Exit freehand full screen" : "Open freehand full screen"}
                    >
            ...
            >
                ...
                {currentPoints.length > 0 && currentPath && <path d={currentPath} fill={currentColor} />}
            </svg>
        </div>
    );
};
