...
import {
	catppuccinLatte,
	catppuccinMocha,
} from "./code-block/editor-themes.ts";
...
function getEditorTopInScrollContainer(
	view: EditorView,
			...
			state: EditorState.create({
				...
				extensions: [
					keymapCompartmentRef.current.of(
						createKeymapExtensions(initialVimModeRef.current),
					),
					minimalSetup,
					markdown({
						addKeymap: true,
					...
					visualThemeCompartmentRef.current.of(
						isDark ? catppuccinMocha() : catppuccinLatte(),
					),
					editorThemeCompartmentRef.current.of(
						createRawMarkdownEditorTheme(initialFontSizeRef.current),
					),
