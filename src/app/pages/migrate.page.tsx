...
export default function MigratePage() {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen p-8 text-center">
            ...
            {status === "no-opener" && (
                <div className="space-y-2">
                    <p className="text-lg font-medium text-danger">Migration Error</p>
                    <p className="text-sm text-muted-foreground">
                        This page must be opened from <strong>app.writeme.dev</strong> using the migration button, not
                        visited directly.
                    </p>
                </div>
            )}
            {status === "error" && (
                <div className="space-y-2">
                    <p className="text-lg font-medium text-danger">Migration Failed</p>
