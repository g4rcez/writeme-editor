...
export default function TemplatePage() {
    ...
    if (!template) return <div className="p-8 mt-20 text-center">Template not found</div>;
    ...
    return (
        <div className="flex flex-col h-full duration-300 bg-background animate-in fade-in">
            ...
            <div className="p-4 border-t border-card-border bg-card-background">
                <p className="font-bold text-center opacity-60 text-xs text-muted-foreground">Template Syntax</p>
                <p className="mt-1 text-xs text-center text-muted-foreground">
                    Use <code className="px-1 rounded bg-primary/5">{"{{VARIABLE_NAME}}"}</code> for placeholders.
                    Standard: <code className="px-1 rounded bg-muted">{"{{DATE}}"}</code>,
