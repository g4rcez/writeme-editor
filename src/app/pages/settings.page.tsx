...
export default function SettingsPage() {
    ...
    return (
        <div className="writeme-settings-shell min-h-full bg-background">
            <main className="mx-auto w-full max-w-5xl px-4 py-6 pb-20 sm:px-6 sm:py-8 xl:px-10">
                <header className="flex flex-col gap-5 border-b border-border/45 pb-6 sm:flex-row sm:items-end sm:justify-between">
                    <div>
                        ...
                        <p className="mt-2 max-w-xl text-sm leading-6 text-muted-foreground">
                            Tune your writing environment, shortcuts, and local workspace.
                        </p>
                    </div>
                    <Button
                        size="small"
                ...
                <div className="mt-6 flex flex-col gap-4">
                    <Card title="Editor" container="writeme-settings-card" className="space-y-4">
                    ...
                    <Card title="Appearance" container="writeme-settings-card">
                        <div className="flex items-center justify-between py-2">
                    ...
                    <AISettings />
                    {isElectron() ? null : (
                        <Card title="Domain Migration" container="writeme-settings-card">
                    ...
                    {isElectron() ? (
                        <Card title="Global Shortcuts" container="writeme-settings-card" className="space-y-2">
                            <div className="flex items-center justify-between py-2">
                    ...
                    {isElectron() ? (
                        <Card title="Workspace" container="writeme-settings-card">
                            <div className="space-y-4">
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    <p className="text-[10px] text-muted-foreground">
                                        ...
                                        <code className="text-primary">quicknotes</code> subdirectory inside your
                                        workspace.
                                    </p>
                                </div>
                            </div>
