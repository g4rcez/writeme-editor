...
export default function GroupsListPage() {
    ...
    const memberCountFor = (groupId: string) => state.noteGroupMembers.filter((m) => m.groupId === groupId).length;
    ...
    return (
        <div className="relative flex-col py-6 mx-auto min-h-full max-w-safe">
            <div className="flex justify-between items-center mb-6">
                ...
                <Button size="small" theme="primary" onClick={() => setShowCreate(true)}>
                ...
                <div className="mb-6 p-4 rounded-lg border border-border bg-card">
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <div className="flex gap-2 justify-end">
                            <Button size="small" theme="ghost-muted" onClick={() => setShowCreate(false)}>
                                Cancel
                            </Button>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {state.noteGroups.map((group) => (
                    ...
                    >
                        ...
                        {group.description && (
                            <p className="text-sm text-foreground/60 line-clamp-2">{group.description}</p>
                        )}
