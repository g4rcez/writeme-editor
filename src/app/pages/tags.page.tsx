...
export default function TagsPage() {
    ...
    if (loading) {
        return <div className="flex justify-center items-center w-full h-full text-foreground">Loading graph...</div>;
    }

    return (
        <div className="overflow-y-hidden relative w-full h-full">
            <div className="absolute top-4 right-8 z-10 p-2 rounded border bg-card-background border-card-border shadow-soft">
            ...
            <TagsGraph nodes={graphData.nodes} links={graphData.links} onNodeClick={onNodeClick} />
        </div>
    );
}
