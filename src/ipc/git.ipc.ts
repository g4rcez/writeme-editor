...
export const gitIpcHandler = () => {
    ipcMain.handle("git:status", async (_, dir: unknown): Promise<GitStatusResult> => {
    ...
    ipcMain.handle("git:commitAndPush", async (_, dir: unknown, message: unknown): Promise<GitPushResult> => {
