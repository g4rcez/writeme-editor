...
describe("runInlineMath", () => {
    ...
    it("renders natural-language date", () => {
        expect(runInlineMath(">>math 12 days ago=")).toBe("12 days ago = 2025-01-03");
    });

    it("renders days-to questions", () => {
        vi.setSystemTime(new Date("2026-06-11T12:00:00.000Z"));

        expect(runInlineMath(">>math how many days to 19/06/2026=")).toBe("how many days to 19/06/2026 = 8 days");
    });
