...
describe("link-utils", () => {
    ...
    describe("linkify", () => {
        ...
        it("should strip wrapping angle brackets", () => {
            expect(linkify("<https://google.com>")).toBe("[https://google.com](https://google.com)");
            expect(linkify("<./note.md>")).toBe("[./note.md](./note.md)");
        });

        it("should separate trailing punctuation from links", () => {
            expect(linkify("https://google.com.")).toBe("[https://google.com](https://google.com).");
            expect(linkify("Check https://google.com,")).toBe("Check [https://google.com](https://google.com),");
            expect(linkify("Visit https://google.com...")).toBe("Visit [https://google.com](https://google.com)...");
        });
