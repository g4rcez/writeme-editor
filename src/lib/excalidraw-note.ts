...
export function normalizeExcalidrawPayload(
  value: unknown,
): ExcalidrawNotePayload {
...
export function buildExcalidrawNoteContent(
  payload: ExcalidrawNotePayload = EMPTY_EXCALIDRAW_PAYLOAD,
): string {
...
export function replaceExcalidrawNotePayload(
  content: string,
  payload: ExcalidrawNotePayload,
): string {
  const normalizedPayload = normalizeExcalidrawPayload(payload);
